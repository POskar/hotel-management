...
const Auth = () => {
    ...
    const inputStyles = "border border-gray-300 sm:text-sm text-black rounded:lg block w-full p-2.5 focus:outline-non"
    ...
    <section className="container mx-auto">
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8 w-80 md:w-[70%] mx-auto">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <input type="text" name="name" placeholder="John Wick" required className={inputStyles} value={formData.name} onChange={handleInputChange} />
